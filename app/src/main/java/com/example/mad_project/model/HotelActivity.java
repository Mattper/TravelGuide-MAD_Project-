        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    list.add(dataSnapshot.getValue(com.example.hotel.HotelModel.class));
                }

                HotelArrayAdapter arrayAdapter = new HotelArrayAdapter(HotelActivity.this, list, getIntent().getBooleanExtra("isAdmin", true));
